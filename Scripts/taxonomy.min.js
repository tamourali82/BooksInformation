                 ...
                 if (this.addTag(tag, taxonomy_jquery.newTags) === true) {
                     ...
                     if (splittedtag.length > 1) {
                         ...
                         for (var i = 0; i < splittedtag.length; i++) {
                             var html = '<li class="label label-default ' + taxonomy_jquery.tagClass.substr(1) + ' ' + taxonomy_jquery.tagActiveClass.substr(1) + '">' + splittedtag[i] + '<a href="#" class="' + taxonomy_jquery.tagUndo.substr(1) + '" ' + taxonomy_jquery.tagSlugData + '="' + taxonomy_jquery.toSlug(splittedtag[i]) + '">' + taxonomy_jquery.undoCharacter + '</a></li>';
                             $(html).prependTo(taxonomy_jquery.listClass);
                             // Add to active tags
                             taxonomy_jquery.addTag(splittedtag[i], taxonomy_jquery.activeTags);
                         }
                     }
                     else {
      ...
      .remove();
         ...
         */
         taxonomy_jquery.toggleInputField = function (boolswitch) {
             ...
             if (boolswitch === true) {
                 var html = '<div class="form-group"><input id="' + taxonomy_jquery.addInput.substr(1) + '" type="text" class="form-control" placeholder="Add ISBNs separated by a comma..."></div>';
